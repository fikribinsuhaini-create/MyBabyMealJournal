import { Baby, BookOpenText, ChefHat, ClipboardList, GalleryVerticalEnd, Home } from 'lucide-react';
import type { ReactNode } from 'react';
import type { AppData, SyncState } from '../types';
import { calculateAge } from '../utils/date';

export type TabKey = 'dashboard' | 'tracker' | 'menu' | 'history' | 'gallery';
...
const navItems: Array<{ key: TabKey; label: string; icon: typeof Home }> = [
  ...
  { key: 'history', label: 'History', icon: BookOpenText },
