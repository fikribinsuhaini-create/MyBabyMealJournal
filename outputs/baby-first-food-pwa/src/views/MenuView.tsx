                      ...
                      <Card key={day} className="overflow-hidden bg-cream p-0">
                        <div className="space-y-3 px-4 py-4">
                          <div className="flex items-start justify-between gap-3">
                            ...
                            >
                              <p className="text-2xl font-black leading-none text-cocoa">{dayLabel(day)}</p>
                              <p className="mt-2 text-sm font-semibold text-cocoa/58">{dayDateLabel}</p>
                            </button>

                            <button
                              type="button"
                              onClick={() => setOpenDay(isDayOpen ? '' : dayKey)}
                              className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-white text-cocoa shadow-sm"
                              aria-label={isDayOpen ? 'Tutup' : 'Buka'}
                            >
                              {isDayOpen ? <ChevronUp size={20} className="text-cocoa/60" /> : <ChevronDown size={20} className="text-cocoa/60" />}
                            </button>
                          </div>
                          ...
                          <div className="flex flex-wrap items-center justify-between gap-2">
                            ...
                            <div className="flex flex-wrap justify-end gap-2">
                              <button
                                ...
                                className="rounded-full bg-white px-3.5 py-2 text-xs font-bold text-cocoa shadow-sm"
                              >
                                + Item
                              </button>
                              <button
                                ...
                                className="rounded-full bg-white px-3.5 py-2 text-xs font-bold text-sageDeep shadow-sm"
                              >
                                Set Tarikh
                              </button>
                            </div>
